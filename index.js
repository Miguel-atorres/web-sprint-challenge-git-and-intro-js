...
console.log('Task 6', addArtist(artists, 'Miguel Torres','1997 - 2022', 'Full Stack Development', 'Amarican', 'Miguel was raised in a small town called Lodi. He joined BloomTech in order to start his carrer in web devlopment.'));
...
console.log('task 7',lotsOfArt(artists, 0));
